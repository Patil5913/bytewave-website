  ...
  const bg =
    tone === "accent"
      ...
      : tone === "faint"
        ...
        : "bg-white/25";
  return (
    <span className={`block h-1.5 rounded-[1px] ${bg}`} style={{ width: w }} />
  );
}
...
function SectionLabel({ w }: { w: string }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <span
        className="h-2 rounded-[1px] bg-emerald-400/80"
        style={{ width: w }}
      />
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className="flex items-center justify-between">
        <span
          className="h-2 rounded-[1px] bg-white/45"
          style={{ width: title }}
        />
        <span
          className="h-1.5 rounded-[1px] bg-white/15"
          style={{ width: date }}
        />
      </div>
