...
const ROLES = [
  { role: "Senior Backend", verified: 18, status: "Shortlist", tone: "text-emerald-400" },
      ...
      <div className="rise flex flex-col gap-2">
        ...
        <div className="flex flex-col divide-y divide-white/5 rounded-lg border border-white/10">
          {[
            ...
            >
              <div className="flex flex-col">
                <span className="text-sm text-white/90">{e.r}</span>
                <span className="text-xs text-white/40">{e.c}</span>
              </div>
              <span className="text-xs text-white/40">{e.y}</span>
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="flex flex-col gap-5 p-5">
      <div className="rise flex items-start justify-between gap-4">
        <div className="flex items-center gap-3.5">
          ...
          <div className="flex flex-col">
            <span className="font-medium text-white">Northwind Labs</span>
            <span className="text-sm text-white/50">Series B · 6 open roles</span>
        ...
        <div className="text-right">
          <div className="font-instrument text-3xl leading-none font-medium text-white">
            <span className="score-num">{FILLED}</span>%
          </div>
          <div className="mt-1 text-xs text-white/40">roles filled</div>
        </div>
      </div>
      ...
      <div className="rise flex flex-col gap-2">
        ...
        <div className="flex flex-col divide-y divide-white/5 rounded-lg border border-white/10">
          {ROLES.map((r) => (
            ...
            >
              <div className="flex flex-col">
                <span className="text-sm text-white/90">{r.role}</span>
